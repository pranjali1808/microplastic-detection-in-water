...
# Load the model
model = tf.keras.models.load_model(r"D:\PROJECT\Image_Recognition_for_Microplastics-main\Image_Recognition_for_Microplastics-main\MicroPystics.keras")
...
def predict():
    ...
    if request.method == "POST":
        ...
        # path = os.path.normpath(os.path.join("static/upload", file.filename))

        path = os.path.join(r"D:\PROJECT\Image_Recognition_for_Microplastics-main\Image_Recognition_for_Microplastics-main\static\upload", file.filename)
        # path = os.path.join(app.config['upload_folder'],file.filename)

        file.save(path)
        # print(path)
        image_path = url_for('static', filename=f'upload/{file.filename}')
        ...
        return render_template("results.html", image_path=image_path, class_predict=class_predict, binary_predictions=binary_predictions, predictions=predictions)
